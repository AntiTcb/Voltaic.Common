...
namespace Voltaic
{
    ...
    public struct Optional<T>
    {
        ...
        public override string ToString() => IsSpecified ? _value?.ToString() : "<unspecified>";
    ...
    public static class Optional
    {
        ...
        public static Optional<T> FromObject<T>(T val)
            where T : class
            => val != null ? new Optional<T>(val) : Optional<T>.Unspecified;
        public static T ToObject<T>(this Optional<T> val)
            where T : class
